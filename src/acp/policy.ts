...
export function isAcpEnabledByPolicy(cfg: ErnOSConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: ErnOSConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: ErnOSConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: ErnOSConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: ErnOSConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: ErnOSConfig, agentId: string): boolean {
