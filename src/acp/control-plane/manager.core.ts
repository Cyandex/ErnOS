...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: ErnOSConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: ErnOSConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: ErnOSConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: ErnOSConfig }): Promise<void> {
