...
function resolveAvatarSource(cfg: ErnOSConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ErnOSConfig, agentId: string): AgentAvatarResolution {
