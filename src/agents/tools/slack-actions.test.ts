...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): ErnOSConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: ErnOSConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: ErnOSConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
