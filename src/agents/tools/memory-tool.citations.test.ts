...
function asErnOSConfig(config: Partial<ErnOSConfig>): ErnOSConfig {
  return config as ErnOSConfig;
}

function createToolConfig() {
  return asErnOSConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: ErnOSConfig = createToolConfig()) {
