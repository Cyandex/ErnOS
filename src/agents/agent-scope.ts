...
type AgentEntry = NonNullable<NonNullable<ErnOSConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: ErnOSConfig): AgentEntry[] {
...
export function listAgentIds(cfg: ErnOSConfig): string[] {
...
export function resolveDefaultAgentId(cfg: ErnOSConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: ErnOSConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentSkillsFilter(cfg: ErnOSConfig, agentId: string): string[] | undefined {
...
export function resolveAgentModelPrimary(cfg: ErnOSConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: ErnOSConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: ErnOSConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
