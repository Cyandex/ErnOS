...
function resolveWatchPaths(workspaceDir: string, config?: ErnOSConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: ErnOSConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ErnOSConfig }) {
