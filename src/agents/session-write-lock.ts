...
const CLEANUP_STATE_KEY = Symbol.for("ernos.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("ernos.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("ernos.sessionWriteLockWatchdogState");
