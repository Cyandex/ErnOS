import type { ErnOSConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityNamePrefix(cfg: ErnOSConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: ErnOSConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[ernos]";
}

/** Helper to extract a channel config value by dynamic key. */
function getChannelConfig(cfg: ErnOSConfig, channel: string): Record<string, unknown> | undefined {
