...
export const DEFAULT_SANDBOX_IMAGE = "ernos-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "ernos-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "ernos-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "ernos-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "ernos-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "ernos-sandbox-browser";
