...
export function listBindings(cfg: ErnOSConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: ErnOSConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ErnOSConfig) {
