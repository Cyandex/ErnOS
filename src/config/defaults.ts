...
function resolveAnthropicDefaultAuthMode(cfg: ErnOSConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ErnOSConfig): ErnOSConfig {
...
export function applyTalkApiKey(config: ErnOSConfig): ErnOSConfig {
...
export function applyTalkConfigNormalization(config: ErnOSConfig): ErnOSConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: ErnOSConfig): ErnOSConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ErnOSConfig): ErnOSConfig {
...
export function applyLoggingDefaults(cfg: ErnOSConfig): ErnOSConfig {
...
export function applyContextPruningDefaults(cfg: ErnOSConfig): ErnOSConfig {
...
export function applyCompactionDefaults(cfg: ErnOSConfig): ErnOSConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
