...
function resolveResolutionLimits(config: ErnOSConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: ErnOSConfig): SecretProviderConfig {
