...
export function listWhatsAppAuthDirs(cfg: ErnOSConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ErnOSConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: ErnOSConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ErnOSConfig): ResolvedWhatsAppAccount[] {
