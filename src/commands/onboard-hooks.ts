...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.ernos.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("ernos hooks list")}`,
      `  ${formatCliCommand("ernos hooks enable <name>")}`,
      `  ${formatCliCommand("ernos hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
