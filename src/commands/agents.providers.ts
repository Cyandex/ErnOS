...
function resolveDefaultAccountId(cfg: ErnOSConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ErnOSConfig): boolean {
...
export function summarizeBindings(cfg: ErnOSConfig, bindings: AgentBinding[]): string[] {
