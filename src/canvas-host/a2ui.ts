...
export const A2UI_PATH = "/__ernos__/a2ui";

export const CANVAS_HOST_PATH = "/__ernos__/canvas";

export const CANVAS_WS_PATH = "/__ernos__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.ernosCanvasA2UIAction.postMessage(...)
  // - Android: window.ernosCanvasA2UIAction.postMessage(...)
  const handlerNames = ["ernosCanvasA2UIAction"];
  ...
  globalThis.ErnOS = globalThis.ErnOS ?? {};
  globalThis.ErnOS.postMessage = postToNode;
  globalThis.ErnOS.sendUserAction = sendUserAction;
  globalThis.ernosPostMessage = postToNode;
  globalThis.ernosSendUserAction = sendUserAction;
