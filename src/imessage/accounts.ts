...
function mergeIMessageAccountConfig(cfg: ErnOSConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: ErnOSConfig): ResolvedIMessageAccount[] {
