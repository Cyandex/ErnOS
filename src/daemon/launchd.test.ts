...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.ernos.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", ERNOS_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.ernos.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when ERNOS_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.ernos.gateway.plist",
    },
    {
      name: "uses profile-specific label when ERNOS_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", ERNOS_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.ernos.jbphoenix.plist",
    },
    {
      name: "prefers ERNOS_LAUNCHD_LABEL over ERNOS_PROFILE",
      env: {
        HOME: "/Users/test",
        ERNOS_PROFILE: "jbphoenix",
        ERNOS_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from ERNOS_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        ERNOS_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty ERNOS_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        ERNOS_PROFILE: "myprofile",
        ERNOS_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.ernos.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
