    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["ernos channels list", "List configured channels and auth profiles."],
          ["ernos channels status --probe", "Run channel status checks and probes."],
          [
            "ernos channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["ernos channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.ernos.ai/cli/channels",
        )}\n`,
    );
