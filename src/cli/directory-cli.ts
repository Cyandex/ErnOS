    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["ernos directory self --channel slack", "Show the connected account identity."],
          [
            'ernos directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["ernos directory groups list --channel discord", "List available groups/channels."],
          [
            "ernos directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.ernos.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
