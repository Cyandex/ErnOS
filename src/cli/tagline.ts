const DEFAULT_TAGLINE = "All your chats, one ErnOS.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little sprout-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just sprouted—type something and let the bot handle the busywork.",
  ...
  "Automation with roots: minimal fuss, maximal growth.",
  ...
  "Sprouts up, commit in—let's ship something mildly responsible.",
  "I'll nurture your workflow like a sprouting seed: steady, natural, effective.",
  "Shell yeah—I'm here to uproot the toil and leave you the glory.",
  ...
  "The only sprout in your contacts you actually want to hear from. 🌱",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.ERNOS_TAGLINE_INDEX;
