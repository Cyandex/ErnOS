      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["ernos gateway run", "Run the gateway in the foreground."],
            ["ernos gateway status", "Show service status and probe reachability."],
            ["ernos gateway discover", "Find local and wide-area gateway beacons."],
            ["ernos gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.ernos.ai/cli/gateway")}\n`,
      ),
  );
