...
const SANDBOX_EXAMPLES = {
  main: [
    ["ernos sandbox list", "List all sandbox containers."],
    ["ernos sandbox list --browser", "List only browser containers."],
    ["ernos sandbox recreate --all", "Recreate all containers."],
    ["ernos sandbox recreate --session main", "Recreate a specific session."],
    ["ernos sandbox recreate --agent mybot", "Recreate agent containers."],
    ["ernos sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["ernos sandbox list", "List all sandbox containers."],
    ["ernos sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["ernos sandbox recreate --all", "Recreate all containers."],
    ["ernos sandbox recreate --session main", "Recreate a specific session."],
    ["ernos sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["ernos sandbox recreate --browser --all", "Recreate only browser containers."],
    ["ernos sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["ernos sandbox explain", "Show effective sandbox config."],
    ["ernos sandbox explain --session agent:main:main", "Explain a specific session."],
    ["ernos sandbox explain --agent work", "Explain an agent sandbox."],
    ["ernos sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.ernos.ai/cli/sandbox")}\n`,
    )
    .action(() => {
