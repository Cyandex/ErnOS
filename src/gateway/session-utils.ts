...
function listConfiguredAgentIds(cfg: ErnOSConfig): string[] {
...
export function listAgentsForGateway(cfg: ErnOSConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ErnOSConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: ErnOSConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: ErnOSConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: ErnOSConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: ErnOSConfig): GatewaySessionsDefaults {
