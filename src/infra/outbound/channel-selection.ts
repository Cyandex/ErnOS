...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: ErnOSConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: ErnOSConfig): Promise<MessageChannelId[]> {
