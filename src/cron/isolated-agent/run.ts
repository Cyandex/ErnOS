...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/ernos/ernos/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.ERNOS_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.ernos/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: ErnOSConfig = {
    ...params.cfg,
