 ...
 */
export const DEFAULT_JOB_TIMEOUT_MS = 2 * 60 * 60_000; // 2 hours (was 10 min) — local autonomous operation
 ...
 */
export const AGENT_TURN_SAFETY_TIMEOUT_MS = 4 * 60 * 60_000; // 4 hours (was 60 min) — local autonomous operation
