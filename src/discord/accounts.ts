...
function mergeDiscordAccountConfig(cfg: ErnOSConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: ErnOSConfig): ResolvedDiscordAccount[] {
