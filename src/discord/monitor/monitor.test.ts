...
describe("agent components", () => {
  const createCfg = (): ErnOSConfig => ({}) as ErnOSConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/ernos-sessions-test.json");
  });
