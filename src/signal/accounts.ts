...
function mergeSignalAccountConfig(cfg: ErnOSConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: ErnOSConfig): ResolvedSignalAccount[] {
