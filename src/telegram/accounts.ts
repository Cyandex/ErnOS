...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ERNOS_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: ErnOSConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: ErnOSConfig): string {
...
function mergeTelegramAccountConfig(cfg: ErnOSConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: ErnOSConfig): ResolvedTelegramAccount[] {
