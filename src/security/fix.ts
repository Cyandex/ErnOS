...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ErnOSConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ErnOSConfig; env: NodeJS.ProcessEnv }): {
  cfg: ErnOSConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
