...
export function listChannelMessageActions(cfg: ErnOSConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: ErnOSConfig): boolean {
...
export function supportsChannelMessageCards(cfg: ErnOSConfig): boolean {
