...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: ErnOSConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: ErnOSConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: "imessage" | "signal") {
  return (params: { cfg: ErnOSConfig; accountId?: string | null }) =>
...
>(params: {
  ...
  resolveMaxBytes: (params: { cfg: ErnOSConfig; accountId?: string | null }) => number | undefined;
