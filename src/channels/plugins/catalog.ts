...
import { discoverErnOSPlugins } from "../../plugins/discovery.js";
import type { ErnOSPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, ErnOSPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["ERNOS_PLUGIN_CATALOG_PATHS", "ERNOS_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<ErnOSPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: ErnOSPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverErnOSPlugins({ workspaceDir: options.workspaceDir });
