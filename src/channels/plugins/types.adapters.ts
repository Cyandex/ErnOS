...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: ErnOSConfig, accountId?: string | null) => ResolvedAccount;
  defaultAccountId?: (cfg: ErnOSConfig) => string;
  setAccountEnabled?: (params: {
    cfg: ErnOSConfig;
    accountId: string;
    enabled: boolean;
  }) => ErnOSConfig;
  deleteAccount?: (params: { cfg: ErnOSConfig; accountId: string }) => ErnOSConfig;
  isEnabled?: (account: ResolvedAccount, cfg: ErnOSConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: ErnOSConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: ErnOSConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: ErnOSConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: ErnOSConfig) => ChannelAccountSnapshot;
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: ErnOSConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
