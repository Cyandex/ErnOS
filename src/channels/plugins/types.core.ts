...
export type ChannelAgentToolFactory = (params: { cfg?: ErnOSConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ErnOSConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ErnOSConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ErnOSConfig }) => boolean;
  supportsCards?: (params: { cfg: ErnOSConfig }) => boolean;
