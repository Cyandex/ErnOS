...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@ernos", { botUsername: "ernos" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@ernos args", {
        botUsername: "ernos",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "ernos" })).toBe("/help@otherbot");
  });
