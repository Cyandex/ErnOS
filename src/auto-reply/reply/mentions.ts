...
function resolveMentionPatterns(cfg: ErnOSConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: ErnOSConfig | undefined, agentId?: string): RegExp[] {
