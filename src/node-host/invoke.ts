...
const execHostEnforced = process.env.ERNOS_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.ERNOS_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
