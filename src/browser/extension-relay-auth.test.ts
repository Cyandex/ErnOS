...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated ernos relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedErnOSRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-ernos-relay-token",
