...
const loadErnOSPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadErnOSPlugins: (params: unknown) => loadErnOSPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadErnOSPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadErnOSPluginsMock.mockClear();
  });
