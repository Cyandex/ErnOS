...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/ernos/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/ernos/extensions",
        global: "/Users/x/.ernos/extensions",
        workspace: "/Users/x/ws/.ernos/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.ernos/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/ernos/extensions",
        global: "/Users/x/.ernos/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.ernos/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/ernos/extensions",
        global: "/Users/x/.ernos/extensions",
