...
export const PLUGIN_MANIFEST_FILENAME = "ernos.plugin.json";
...
// package.json "ernos" metadata (used for onboarding/catalog)
...
export type ErnOSPackageManifest = {
  extensions?: string[];
...
): ErnOSPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
