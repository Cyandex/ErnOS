...
export type ErnOSPluginConfigSchema = {
...
export type ErnOSPluginToolContext = {
  config?: ErnOSConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type ErnOSPluginToolFactory = (
  ctx: ErnOSPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type ErnOSPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type ErnOSPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<ErnOSConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type ErnOSPluginGatewayMethod = {
  method: string;
 ...
 */
export type ErnOSPluginCommandDefinition = {
...
export type ErnOSPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type ErnOSPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type ErnOSPluginCliContext = {
  program: Command;
  config: ErnOSConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type ErnOSPluginCliRegistrar = (ctx: ErnOSPluginCliContext) => void | Promise<void>;

export type ErnOSPluginServiceContext = {
  config: ErnOSConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type ErnOSPluginService = {
  id: string;
  start: (ctx: ErnOSPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: ErnOSPluginServiceContext) => void | Promise<void>;
};

export type ErnOSPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type ErnOSPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: ErnOSPluginConfigSchema;
  register?: (api: ErnOSPluginApi) => void | Promise<void>;
  activate?: (api: ErnOSPluginApi) => void | Promise<void>;
};

export type ErnOSPluginModule =
  | ErnOSPluginDefinition
  | ((api: ErnOSPluginApi) => void | Promise<void>);

export type ErnOSPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | ErnOSPluginToolFactory,
    opts?: ErnOSPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: ErnOSPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: ErnOSPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: ErnOSPluginHttpRouteHandler }) => void;
  registerChannel: (registration: ErnOSPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: ErnOSPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: ErnOSPluginService) => void;
   ...
   */
  registerCommand: (command: ErnOSPluginCommandDefinition) => void;
