...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @ernos/voice-call -> voice-call).
...
export function discoverErnOSPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".ernos", "extensions")];
