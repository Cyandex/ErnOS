...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.ERNOS_TTS_PREFS;
      process.env.ERNOS_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.ERNOS_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: ErnOSConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
