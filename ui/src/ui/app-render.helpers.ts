...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as ErnOSApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as ErnOSApp).resetToolStream();
  (state as unknown as ErnOSApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as ErnOSApp;
