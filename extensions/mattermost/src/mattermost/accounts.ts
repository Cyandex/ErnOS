...
export function listMattermostAccountIds(cfg: ErnOSConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: ErnOSConfig): string {
...
export function listEnabledMattermostAccounts(cfg: ErnOSConfig): ResolvedMattermostAccount[] {
