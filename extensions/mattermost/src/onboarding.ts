import type { ChannelOnboardingAdapter, ErnOSConfig, WizardPrompter } from "ernos/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.ernos.ai/channels/mattermost",
    ].join("\n"),
