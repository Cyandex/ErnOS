...
import type { ReplyPayload, ErnOSConfig } from "ernos/plugin-sdk";
import { createReplyPrefixOptions } from "ernos/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as ErnOSConfig;
