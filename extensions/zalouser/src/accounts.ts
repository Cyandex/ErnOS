...
export function listZalouserAccountIds(cfg: ErnOSConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: ErnOSConfig): string {
...
function mergeZalouserAccountConfig(cfg: ErnOSConfig, accountId: string): ZalouserAccountConfig {
