...
This directory contains the **BlueBubbles external channel plugin** for ErnOS.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `ernos/plugin-sdk` helpers.
