...
import { resolveChannelMediaMaxBytes, type ErnOSConfig } from "ernos/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: ErnOSConfig; accountId?: string }): string[] {
