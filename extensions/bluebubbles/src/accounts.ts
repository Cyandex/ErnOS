...
export function listBlueBubblesAccountIds(cfg: ErnOSConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: ErnOSConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: ErnOSConfig): ResolvedBlueBubblesAccount[] {
