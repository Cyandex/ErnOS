...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "ernos/plugin-sdk";
import {
  ACPX_PINNED_VERSION,
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: ErnOSPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: ErnOSPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
