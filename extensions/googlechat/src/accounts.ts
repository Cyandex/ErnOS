...
export function listGoogleChatAccountIds(cfg: ErnOSConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: ErnOSConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: ErnOSConfig): ResolvedGoogleChatAccount[] {
