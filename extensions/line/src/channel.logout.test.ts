import type { ErnOSConfig, PluginRuntime, ResolvedLineAccount } from "ernos/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: ErnOSConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: ErnOSConfig; accountId: string }): Promise<{
