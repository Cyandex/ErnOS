...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "ernos/plugin-sdk";
...
import { resolvePreferredErnOSTmpDir } from "../../../src/infra/tmp-ernos-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredErnOSTmpDir(), "msteams-mention-"));
