...
Nostr DM channel plugin for ErnOS using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to ErnOS. It enables your bot to:
...
# Configure ernos to use local relay
