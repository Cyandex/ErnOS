...
read_when:
  - You are building a ErnOS plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (ernos.plugin.json)

Every plugin **must** ship a `ernos.plugin.json` file in the **plugin root**.
ErnOS uses this manifest to validate configuration **without executing plugin
