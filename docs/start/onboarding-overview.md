---
summary: "Overview of ErnOS onboarding options and flows"
read_when:
...
ErnOS supports multiple onboarding paths depending on where the Gateway runs
...
- [`ernos onboard` command](/cli/onboard)

## macOS app onboarding

Use the ErnOS app when you want a fully guided setup on macOS. Docs:
