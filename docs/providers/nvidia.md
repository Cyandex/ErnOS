---
summary: "Use NVIDIA's OpenAI-compatible API in ErnOS"
read_when:
  - You want to use NVIDIA models in ErnOS
...
ernos onboard --auth-choice skip
ernos models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
