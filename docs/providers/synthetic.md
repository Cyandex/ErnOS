---
summary: "Use Synthetic's Anthropic-compatible API in ErnOS"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. ErnOS registers it as the
...
Note: ErnOS's Anthropic client appends `/v1` to the base URL, so use
