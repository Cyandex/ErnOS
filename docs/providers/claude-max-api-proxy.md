...
You can point ErnOS at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ErnOS
...
- [Anthropic provider](/providers/anthropic) - Native ErnOS integration with Claude setup-token or API keys
