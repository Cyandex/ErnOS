---
summary: "Use Kilo Gateway's unified API to access many models in ErnOS"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in ErnOS
---
...
```bash
ernos onboard --kilocode-api-key <key>
```
