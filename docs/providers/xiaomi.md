---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with ErnOS"
read_when:
  - You want Xiaomi MiMo models in ErnOS
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). ErnOS uses
