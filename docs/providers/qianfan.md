---
summary: "Use Qianfan's unified API to access many models in ErnOS"
read_when:
...
3. ErnOS installed on your system
...
4. Copy the API key for use with ErnOS

## CLI setup

```bash
ernos onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [ErnOS Configuration](/gateway/configuration)
