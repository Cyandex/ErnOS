...
本指南总结了在 ErnOS 中开发 Pi 集成的合理工作流程。
...
状态存储在 ErnOS 状态目录下。默认为 `~/.ernos`。如果设置了 `ERNOS_STATE_DIR`，则使用该目录。
...
- https://docs.ernos.ai/testing
- https://docs.ernos.ai/start/getting-started
