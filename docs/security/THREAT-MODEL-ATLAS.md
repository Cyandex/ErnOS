...
This is a living document maintained by the ErnOS community. See [CONTRIBUTING-THREAT-MODEL.md](./CONTRIBUTING-THREAT-MODEL.md) for guidelines on contributing:
...
This threat model documents adversarial threats to the ErnOS AI agent platform and ErnHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component            | Included | Notes                                            |
| -------------------- | -------- | ------------------------------------------------ |
| ErnOS Agent Runtime  | Yes      | Core agent execution, tool calls, sessions       |
| Gateway              | Yes      | Authentication, routing, channel integration     |
| Channel Integrations | Yes      | WhatsApp, Telegram, Discord, Signal, Slack, etc. |
| ErnHub Marketplace   | Yes      | Skill publishing, moderation, distribution       |
...
| F5   | ErnHub  | Agent       | Skill code         | Moderation, scanning |
...
| **Description**         | Attacker scans for exposed ErnOS gateway endpoints                   |
...
| **Affected Components** | ~/.ernos/credentials/, config storage                       |
...
| **Description**         | Attacker publishes malicious skill to ErnHub                             |
| **Attack Vector**       | Create account, publish skill with hidden malicious code                 |
| **Affected Components** | ErnHub, skill loading, agent execution                                   |
...
| **Affected Components** | ErnHub versioning, auto-update flows                           |
...
| **Affected Components** | ErnHub moderation.ts                                                   |
...
## 4. ErnHub Supply Chain Analysis
...
| ATLAS ID      | Technique Name                 | ErnOS Threats                                                    |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| `convex/lib/moderation.ts`          | ErnHub moderation           | **High**     |
...
| **ErnHub**           | ErnOS's skill marketplace                                 |
| **Gateway**          | ErnOS's message routing and authentication layer          |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for ErnOS agents                   |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@ernos.ai_
