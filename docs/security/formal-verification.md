...
summary: Machine-checked security models for ErnOS’s highest-risk paths.
read_when:
...
This page tracks ErnOS’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that ErnOS enforces its
...
**What this is not (yet):** a proof that “ErnOS is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/ernos-formal-models](https://github.com/vignesh07/ernos-formal-models).
...
```bash
git clone https://github.com/vignesh07/ernos-formal-models
cd ernos-formal-models
