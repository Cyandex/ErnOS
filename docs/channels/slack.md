...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure ErnOS HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `ernos pairing approve slack <code>`.
...
ErnOS supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, ErnOS falls back to normal delivery for remaining payloads.
