...
- Install via CLI: `ernos plugins install @ernos/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `ernos plugins install ./extensions/zalo`
   - From npm (if published): `ernos plugins install @ernos/zalo`
...
- Approve via:
  - `ernos pairing list zalo`
  - `ernos pairing approve zalo <CODE>`
...
- Example: `ernos message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `ernos channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `ernos logs --follow`
