...
ErnOS ships three update channels:
...
When you **explicitly** switch channels with `--channel`, ErnOS also aligns
the install method:
...
When you switch channels with `ernos update`, ErnOS also syncs plugin sources:
