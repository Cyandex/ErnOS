...
ErnOS treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.ernos/settings/voicewake.json`

Shape:

```json
{ "triggers": ["ernos", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
