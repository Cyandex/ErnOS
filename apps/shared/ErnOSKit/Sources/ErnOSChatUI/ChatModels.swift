...
public typealias ErnOSPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ErnOSPlatformImage = UIImage
#endif

public struct ErnOSChatUsageCost: Codable, Hashable, Sendable {
...
public struct ErnOSChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ErnOSChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ErnOSChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ErnOSChatMessageContent: Codable, Hashable, Sendable {
...
public struct ErnOSChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ErnOSChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ErnOSChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ErnOSChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ErnOSChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(ErnOSChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([ErnOSChatMessageContent].self, forKey: .content) {
...
public struct ErnOSChatHistoryPayload: Codable, Sendable {
...
public struct ErnOSSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ErnOSSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ErnOSSessionPreviewItem]
}

public struct ErnOSSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ErnOSSessionPreviewEntry]

    public init(ts: Int, previews: [ErnOSSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ErnOSChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ErnOSChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ErnOSAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ErnOSChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct ErnOSGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ErnOSPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ErnOSPlatformImage?
...
public struct ErnOSChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
