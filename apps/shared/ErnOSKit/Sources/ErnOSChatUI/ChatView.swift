...
@MainActor
public struct ErnOSChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: ErnOSChatViewModel
    ...
    private var visibleMessages: [ErnOSChatMessage] {
        let base: [ErnOSChatMessage]
    ...
    private func mergeToolResults(in messages: [ErnOSChatMessage]) -> [ErnOSChatMessage] {
    ...
    private func isToolResultMessage(_ message: ErnOSChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: ErnOSChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: ErnOSChatMessage) -> String {
