...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.ernos", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.ernos", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: ErnOSProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
