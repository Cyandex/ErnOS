...
public enum ErnOSTalkCommand: String, Codable, Sendable {
...
public struct ErnOSTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct ErnOSTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
