...
public enum ErnOSCanvasA2UICommand: String, Codable, Sendable {
...
public struct ErnOSCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ErnOSCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
