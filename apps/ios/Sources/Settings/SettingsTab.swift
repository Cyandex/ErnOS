...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = ErnOSLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = ErnOSLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.ernos.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected ErnOS agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for ErnOS. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(ErnOSLocationMode.off.rawValue)
                            Text("While Using").tag(ErnOSLocationMode.whileUsing.rawValue)
                            Text("Always").tag(ErnOSLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while ErnOS is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("ErnOS", value: DeviceInfoHelper.ernOSVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = ErnOSLocationMode(rawValue: newValue) else { return }
                Task {
