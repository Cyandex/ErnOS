...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.ernos.gateway"
    private static let nodeService = "ai.ernos.node"
    private static let talkService = "ai.ernos.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.ernos.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.ernos.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("ernos-gateway.log")
    }
