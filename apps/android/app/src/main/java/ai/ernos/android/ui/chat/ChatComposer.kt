...
import ai.ernos.android.ui.mobileSurface
import ai.ernos.android.ui.mobileText
import ai.ernos.android.ui.mobileTextSecondary
import ai.ernos.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.ernos.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.ernos.android.ui.mobileFontFamily,
