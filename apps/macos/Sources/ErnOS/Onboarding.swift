...
enum UIStrings {
    static let welcomeTitle = "Welcome to ErnOS"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "ernos.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: ErnOSChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g ernos@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ErnOSChatViewModel(
