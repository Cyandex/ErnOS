...
enum ErnOSConfigFile {
    private static let logger = Logger(subsystem: "ai.ernos", category: "config")
    ...
    static func stateDirURL() -> URL {
        ErnOSPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        ErnOSPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-ernos-config-file",
            "event": "config.write",
