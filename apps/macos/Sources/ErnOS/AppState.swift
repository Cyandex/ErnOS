...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = ErnOSConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ErnOSConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = ErnOSConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/ernos"
        state.remoteCliPath = ""
        return state
    }
}
