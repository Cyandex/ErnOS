...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.ernos", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other ErnOS windows, but below the system’s pop-up menus.
