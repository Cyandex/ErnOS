...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.ernos", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("ErnOS/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__ernos__/a2ui/").absoluteString + "?platform=macos"
    }
