...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.ernos", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.ernos", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [ErnOSChatMessage] = messages.compactMap { item in
