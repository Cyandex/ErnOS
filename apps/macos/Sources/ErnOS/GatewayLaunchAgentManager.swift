...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.ernos", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".ernos/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.ernosCommand(
            subcommand: "gateway",
