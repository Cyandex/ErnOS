...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/ernos/ernos") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/ernos/ernos")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://ernos.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "ErnOSBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ErnOSBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ErnOSGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ErnOSGitCommit") as? String) ??
            "unknown"
    }
