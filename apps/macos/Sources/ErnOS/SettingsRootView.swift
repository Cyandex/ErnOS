...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .ernosSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ErnOSPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ErnOSPaths.stateDirURL.path
...
extension Notification.Name {
    static let ernosSelectSettingsTab = Notification.Name("ernosSelectSettingsTab")
}
