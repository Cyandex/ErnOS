...
show_usage() {
    cat << EOF
clawlog - ErnOS Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View ErnOS logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    ErnOS logs flow through the macOS unified log (subsystem: ai.ernos).
