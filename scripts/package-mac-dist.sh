...
# Output:
# - dist/ErnOS.app
# - dist/ErnOS-<version>.zip
# - dist/ErnOS-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.ernos.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/ErnOS.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/ErnOS-$VERSION.zip"
DMG="$ROOT_DIR/dist/ErnOS-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/ErnOS-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/ErnOS-$VERSION.dSYM.zip"
