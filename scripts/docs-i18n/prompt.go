...
- Keep product names in English: ErnOS, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the ErnOS Gateway, use “Gateway 网关”.
