...
export DISPLAY=:1
export HOME=/tmp/ernos-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${ERNOS_BROWSER_CDP_PORT:-${ERNOS_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${ERNOS_BROWSER_CDP_SOURCE_RANGE:-${ERNOS_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${ERNOS_BROWSER_VNC_PORT:-${ERNOS_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${ERNOS_BROWSER_NOVNC_PORT:-${ERNOS_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${ERNOS_BROWSER_ENABLE_NOVNC:-${ERNOS_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${ERNOS_BROWSER_HEADLESS:-${ERNOS_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${ERNOS_BROWSER_NO_SANDBOX:-${ERNOS_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${ERNOS_BROWSER_NOVNC_PASSWORD:-${ERNOS_BROWSER_NOVNC_PASSWORD:-}}"
